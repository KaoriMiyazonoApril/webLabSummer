            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ textAlign: 'center' }}>
                        <img
                            src={sessionStorage.getItem('avatar') || DEFAULT_AVATAR}
                            alt="用户头像"
                    ...
                    <div style={{
                        ...
                        <div style={infoItemStyle}>
                            ...
                            <span style={valueStyle}>{sessionStorage.getItem('username')}</span>
                        </div>
                        <div style={infoItemStyle}>
                            <span style={labelStyle}>电话号码:</span>
                            <span style={valueStyle}>{sessionStorage.getItem('telephone')}</span>
                        </div>
                    </div>
                </div>
            </div>
